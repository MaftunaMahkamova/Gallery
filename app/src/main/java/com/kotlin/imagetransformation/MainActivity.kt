package com.kotlin.imagetransformation
...
if(index == 0){
    Toast.makeText(this@MainActivity,"Bundan oldin rasm yo'q",Toast.LENGTH_SHORT).show()
}
    }
    fun next(){
        ...
        if(index == imgArray.size-1){
            Toast.makeText(this@MainActivity,"Bundan keyin rasm yo'q",Toast.LENGTH_SHORT).show()
        }
